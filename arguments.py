...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='imagenette2', help='Name of the dataset used.')
    ...
    parser.add_argument('--data_path', type=str, default='./data/imagenette2/train', help='Path to where the data is')
    ...
    parser.add_argument('--select', type=str, default='vae')
